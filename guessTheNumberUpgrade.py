...
def playGame( showAnswer ):
    print('Hi there! Would you like to play a game?')
    print('Please enter the highest number that you would like to guess up to')
    userinput = int(input()) 
    print('How many tries would you like to have?')
